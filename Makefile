...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix spaday_lightweight_charts
	python -m ruff format spaday_lightweight_charts

fix-js:  ## fix js formatting
	cd js; pnpm fix

fix-docs:  ## autoformat docs with mdformat and codespell
	python -m mdformat README.md docs/src/*.md
	python -m codespell_lib --write README.md docs/src/*.md
...
test-py:  ## run python tests
	python -m pytest -v spaday_lightweight_charts/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v spaday_lightweight_charts/tests --cov=spaday_lightweight_charts --cov-report term-missing --cov-report xml
